...
// Buscamos apenas os pedidos que ESTE entregador aceitou
$pedidos = $pedidoDAO->listarMinhasEntregas($_SESSION['cod']);
?>
...
<head>
    ...
    <title>Minhas Entregas | WasabiDO</title>
    ...
    <style>
        ...
        /* ESTILO PARA LINKS AUXILIARES / TELA VAZIA */
        .btn-outline-marca {
            color: var(--accent-red);
...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="mb-5 text-center text-md-start">
            <h2 class="page-title">Minhas <span>Entregas</span></h2>
            <p class="text-secondary-custom">Pedidos aceitos aguardando saída da cozinha</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <?php if (empty($pedidos)) { ?>
                <div class="col-12 text-center mt-5">
                    ...
                    <p class="text-secondary-custom mt-3">Você não tem nenhuma entrega pendente de saída no momento.</p>
                    <a href="pedidosE.php"
                        class="btn btn-outline-marca px-4 py-2 mt-2 rounded-3 text-decoration-none d-inline-block">
